...
public class SliderTest {
    ...
    private void slider(WebDriver driver) throws InterruptedException {
        ...
        Thread.sleep((long) (Math.random() * 10000));
        String href = driver.findElement(By.xpath("//div[2]/div/figure/img")).getAttribute("href");
        driver.findElement(By.xpath("(//a[contains(@href, '#')])[2]")).click();
        Thread.sleep((long) (Math.random() * 10000));
        Assertions.assertNotEquals(href, driver.findElement(By.xpath("//div[2]/div/figure/img")).getAttribute("href"));
    }

    @Test
    public void sliderChrome() throws InterruptedException {
        slider(chromeDriver);
    }

    @Test
    public void sliderFirefox() throws InterruptedException {
        slider(firefoxDriver);
    }
